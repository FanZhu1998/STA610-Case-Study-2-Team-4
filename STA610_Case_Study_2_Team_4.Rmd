...
```
## Introduction
In this case study, we have built a Bayesian hierarchical model for the 2020 Presidential Election to investigate how different demographic variables lead to the turnout rates and the evidence of heterogeneity across counties. Our data sets include both the aggregate counts of registered voters and voters who actually voted by the demographic variables. 
